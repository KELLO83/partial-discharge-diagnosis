...
戍式式 PRPD image (*.png)
戍式式 partial-discharge time-series data (*.csv)
戌式式 label and metadata (*.json)
```
...
戌式式 noise_solid_ACSR-OC_230910_195222_HFCT_1000.csv

source PNG:
Train/source/VS_noise_solid_ACSR-OC/
戌式式 noise_solid_ACSR-OC_230910_195222_HFCT_1000.png

label JSON:
Train/labels/VL_noise_solid_ACSR-OC/
戌式式 noise_solid_ACSR-OC_230910_195222_HFCT_1000.json
```
...
弛   戍式式 PD_type
弛   戍式式 image_path
弛   戌式式 timeseries_path
戌式式 metadata
    戍式式 equipment_information
    戍式式 environment
    戍式式 discharge_information
    戌式式 discharge_evaluation_factors
```
