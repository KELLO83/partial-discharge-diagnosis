...
from ml.vlm.src.schema import ManifestVlmRow, PD_LABELS_KO, TimeSeriesContext


def build_prompt_text(row: ManifestVlmRow, context: TimeSeriesContext | None) -> str:
